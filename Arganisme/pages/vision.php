	...
	<div id="content" class="container" align="center">
		...
		<section class="sec" id="article">
			<center>
				<h1>Vision</h1>
				<p>
				Argan oil is a plant oil produced by Cold Pressed Machine from the kernels of the Moroccan argan tree using a sustainable production system.

				Argan oil has been known as a powerful hydrating, anti-oxidant, and anti-inflammatory beauty treatment;

				Argan oil is known for its numerous benefits for hair, body, nails, and hair because it contains a high level of vitamin A and E.

				Argan oil is essential to our everyday life since it’s used in shampoos, soaps, body creams, massage lotions, lip creams, and many other uses.

				Our main mission is to share these age-gold beauty secrets of organic argan oil with our customers using a sustainable production system. We can provide a certified 100% pure argania spinosa kernel oil.
				</p>
			</center>
		</section>
	</div>
