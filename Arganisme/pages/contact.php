...
<body>
	...
	<div id="content" class="container" align="center">
		...
		<div class="row">
			<div class="Formular col" id="orderFormular" align="left">
	            <form id="contact-form2" method="post" action="" role="form">
	                <div class="row">
	                    <div class="col-lg-6">
	                    ...
	                    <div >
	                        <label for="subject" class="form-label">Subject <span class="blue">*</span></label>
			...
			<div class="textArea col" id="Tcontact">
				<h2 class="textAreaItem" id="ContactInfo">Contact info :</h2>
				<h5 class="textAreaItem" id="Smail">Email: contact@www.arganismecosmetics.com</h5>
				<h5 class="textAreaItem" id="Stel">Tel: +212 651 925 398</h5>
				<h2 class="textAreaItem" id="ContactInfo">Address :</h2>
				<h5 class="textAreaItem" id="Smail">Marrakech : office.marrakesh@www.arganismecosmetics.com</h5>
				<h5 class="textAreaItem" id="Smail">Essaouira : office.essaouira@www.arganismecosmetics.com</h5>
				<h5 class="textAreaItem" id="Smail">Casablanca : office.casablanca@www.arganismecosmetics.com</h5>
			</div>
		</div>
	</div>
