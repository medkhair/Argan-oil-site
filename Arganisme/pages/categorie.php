		...
		<section class="sec" id="products">
			<?php
				...
				echo '
					...
					<div class="row">';
					$statement = $connection->prepare('SELECT * FROM categories WHERE name = :ide');
					...
					$statement = $connection->prepare('SELECT * FROM products WHERE category = :num');
					...
					echo '
						<div class="product col">
							<a href="product.php?name='.$products['name'].'">
								<div class="img2" id="'.$products['id'].'" style="background-image: url(../images/'.$products['image'].');">
								</div>
							</a>
							<p class="pTitle">'.$products['name'].'</p>
						</div>
					';
				}
			?>
